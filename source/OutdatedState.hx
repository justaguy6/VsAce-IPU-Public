	...
	override function create()
	{
		...
		if(customUpdateScreen) {
			...
			if(TitleState.updateVersion == null)
				TitleState.updateVersion = MainMenuState.aceVer;
		} else {
			var http = new haxe.Http("https://raw.githubusercontent.com/KamexVGM/VsAce-Internet-Stuff/main/updateScreen.hscript");
		...
		warnText = new FlxFixedText(0, 0, FlxG.width,
			"The build you're playing is outdated (" + MainMenuState.aceVer + "),\n
...
class HScript
{
	...
	public function new()
	{
		...
		interp.variables.set('acceptLink', "https://gamebanana.com/mods/311759");
