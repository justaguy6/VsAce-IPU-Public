...
class MenuCharacter extends FlxSprite
{
	private static var settings:Map<String, CharacterSetting> = [
		...
		'mace' => new CharacterSetting(-15, 130, 1.1),
		'mbf' => new CharacterSetting(-1, 0, true),
	];
	...
	public function new(x:Int, y:Int, scale:Float, flipped:Bool)
	{
		...
		animation.addByPrefix('ace', "Ace_Idle", 24, false);
		animation.addByPrefix('mace', "Minace_Idle0", 24, false);
		animation.addByPrefix('mbf', "Minus_BF_Idle0", 24, false);
		animation.addByPrefix('mbfConfirm', "Minus_BF_Idle0", 24, false);
