...
class ChartingState extends MusicBeatState
{
	...
	**/
	...
	public var snapText:FlxFixedText;
	...
	override function create()
	{
		...
		texts = new FlxTypedGroup<FlxFixedText>();
		...
		snapText = new FlxFixedText(60,10,0,"", 14);
	...
	public var texts:FlxTypedGroup<FlxFixedText>;
	...
	function regenerateLines()
	{
		...
		if (_song.eventObjects != null)
			for(i in _song.eventObjects)
			{
				...
				var text = new FlxFixedText(-190, pos,0,i.name + "\n" + type + "\n" + i.value,12);
	...
	function addEventsUI()
	{
		...
		var listLabel = new FlxFixedText(10, 5, 'List of Events');
		var nameLabel = new FlxFixedText(150, 5, 'Event Name');
		var eventName = new FlxUIInputText(150,20,80,"");
		var typeLabel = new FlxFixedText(10, 45, 'Type of Event');
		var eventType = new FlxUIDropDownMenu(10,60,FlxUIDropDownMenu.makeStrIdLabelArray(["BPM Change", "Scroll Speed Change"], true));
		var valueLabel = new FlxFixedText(150, 45, 'Event Value');
		...
		var posLabel = new FlxFixedText(150, 85, 'Event Position');
	...
	function addSongUI():Void
	{
		...
		var stepperBPMLabel = new FlxFixedText(74,65,'BPM');

		var stepperSpeed:FlxUINumericStepper = new FlxUINumericStepper(10, 80, 0.1, 1, 0.1, 10, 1);
		stepperSpeed.value = _song.speed;
		stepperSpeed.name = 'song_speed';

		var stepperSpeedLabel = new FlxFixedText(74,80,'Scroll Speed');
		...
		var stepperVocalVolLabel = new FlxFixedText(74, 95, 'Vocal Volume');
		...
		var stepperSongVolLabel = new FlxFixedText(74, 110, 'Instrumental Volume');

		var shiftNoteDialLabel = new FlxFixedText(10, 245, 'Shift Note FWD by (Section)');
		...
		var shiftNoteDialLabel2 = new FlxFixedText(10, 275, 'Shift Note FWD by (Step)');
		...
		var shiftNoteDialLabel3 = new FlxFixedText(10, 305, 'Shift Note FWD by (ms)');
		...
		var player1Label = new FlxFixedText(10,80,64,'Player 1');
		...
		var player2Label = new FlxFixedText(140,80,64,'Player 2');
		...
		var gfVersionLabel = new FlxFixedText(10,180,64,'Girlfriend');
		...
		var stageLabel = new FlxFixedText(140,180,64,'Stage');
		...
		var noteStyleLabel = new FlxFixedText(10,280,64,'Note Skin');
	...
	function addSectionUI():Void
	{
		...
		var stepperCopyLabel = new FlxFixedText(174,132,'sections back');
	...
	function addNoteUI():Void
	{
		...
		tab_group_note.add(new FlxFixedText(74,10,'Note Sustain Length'));
	...
	override function update(elapsed:Float)
	{
		...
		if (doInput && FlxG.keys.justPressed.ANY)
		{
