...
class OptionsMenu extends MusicBeatState
{
	...
	override function create()
	{
		...
		versionShit = new FlxFixedText(5, FlxG.height + 40, 0, "Offset (Left, Right, Shift for slow): " + HelperFunctions.truncateFloat(FlxG.save.data.offset,2) + " - Description - " + currentDescription, 12);
